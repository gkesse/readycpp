...
namespace process
{
    ...
    TEST_F(TestProcess, Test_Module_Aide)
    {
        ...
        Process::Module DEF_MODULE_HELP =
            {Process::MODULE_TYPE::HELP, "help", "Affiche l'aide."};
  ...
  - Liste des modules disponibles:
    ...
    TEST_F(TestProcess, Test_Egalite_Modules)
    {
        ...
        const TestParamList test_param_list = {
            // {m_index: 0 | m_module: DEF_MODULE_HELP_OK_1_1 | m_result: {m_est_egal: true}}
            {0, DEF_MODULE_HELP_OK_1_1, {true}},
            // {_index: 1 | m_module: DEF_MODULE_BDD_NOK_1_1 | m_result: {m_est_egal: false}}
            {1, DEF_MODULE_BDD_NOK_1_1, {false}},
            // {_index: 2 | m_module: DEF_MODULE_HELP_NOK_2_1 | m_result: {m_est_egal: false}}
            {2, DEF_MODULE_HELP_NOK_2_1, {false}},
            // {_index: 3 | m_module: DEF_MODULE_HELP_NOK_1_2 | m_result: {m_est_egal: false}}
    ...
    TEST_F(TestProcess, Test_Chargement_Module)
    {
        ...
        const Process::ArgList DEF_ARGS_VIDE_OK =
            {"readycpp", ""};

        // cree des arguments cli inconnu (nok)
        const Process::ArgList DEF_ARGS_INCONNU_NOK =
            {"readycpp", "unknown"};

        // cree des arguments cli inconnu (ok)
        const Process::ArgList DEF_ARGS_INCONNU_OK =
            {"readycpp", "inconnu"};

        // cree des arguments cli help (ok)
        const Process::ArgList DEF_ARGS_HELP_OK =
            {"readycpp", "help"};

        // cree des arguments cli bdd (ok)
        const Process::ArgList DEF_ARGS_BDD_OK =
            {"readycpp", "bdd"};
        ...
        // cree un module inconnu (ok)
        const Process::Module DEF_MODULE_HELP_OK =
            {Process::MODULE_TYPE::HELP, "help", "Affiche l'aide."};

        // cree un module bdd (ok)
        const Process::Module DEF_MODULE_BDD_OK =
            {Process::MODULE_TYPE::BDD, "bdd", "Execute le module de gestion de base de donnees."};

        // remplit une liste de structure de tests parametriques
        const TestParamList test_param_list = {
            // {m_index: 0 | m_arg_list: DEF_ARGS_VIDE_OK | m_result: {m_est_ok: false | m_module: DEF_MODULE_HELP_OK}}
            {0, DEF_ARGS_VIDE_OK, {true, DEF_MODULE_HELP_OK}},
            // {m_index: 1 | m_arg_list: DEF_ARGS_INCONNU_NOK | m_result: {m_est_ok: false | m_module: DEF_MODULE_INCONNU_OK}}
            {1, DEF_ARGS_INCONNU_NOK, {false, DEF_MODULE_INCONNU_OK}},
            // {_index: 2 | m_arg_list: DEF_ARGS_INCONNU_OK | m_result: {m_est_ok: false | m_module: DEF_MODULE_INCONNU_OK}}
            {2, DEF_ARGS_INCONNU_OK, {false, DEF_MODULE_INCONNU_OK}},
            // {_index: 3 | m_arg_list: DEF_ARGS_HELP_OK | m_result: {m_est_ok: true | m_module: DEF_MODULE_HELP_OK}}
            {3, DEF_ARGS_HELP_OK, {true, DEF_MODULE_HELP_OK}},
            // {_index: 4 | m_arg_list: DEF_ARGS_BDD_OK | m_result: {m_est_ok: true | m_module: DEF_MODULE_BDD_OK}}
    ...
    TEST_F(TestProcess, Test_Execution_Module)
    {
        ...
        // remplit une liste de structure de tests parametriques
        const TestParamList test_param_list = {
            // {m_index: 0 | m_arg_list: DEF_ARGS_INCONNU_NOK | m_result: {m_est_ok: false}}
            {0, DEF_ARGS_INCONNU_NOK, {false}},
            // {_index: 1 | m_arg_list: DEF_ARGS_INCONNU_OK | m_result: {m_est_ok: false}}
            {1, DEF_ARGS_INCONNU_OK, {false}},
            // {_index: 2 | m_arg_list: DEF_ARGS_HELP_OK | m_result: {m_est_ok: true}}
            {2, DEF_ARGS_HELP_OK, {true}},
            // {_index: 3 | m_arg_list: DEF_ARGS_BDD_OK | m_result: {m_est_ok: true}}
